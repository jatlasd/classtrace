...
- Explore opens directly onto an evidence ledger, with an inline **Filters**
  disclosure and **Evidence / Group by student** view controls. A compact indigo
  header offers direct student, tag, and date entry points; the editor groups
  fields as **Who / What / When** with optional matching guidance. Applied scope and
...
Use direct teacher language: Capture, Explore evidence, Show results, Update results, What happened?, Review before saving, Evidence note, Student, Class, Tags, Follow-up, Timeline, Report, Archive, Delete.
